...
public enum Command : byte
{
    ...
    /// <summary>
    /// Запрос состояния подсветки кнопки Средство от насекомых
    /// </summary>
    GetBacklightButtonInsect = 0x2F,

    /// <summary>
    /// Запрос состояния подсветки кнопки Пена
    /// </summary>
    GetBacklightButtonFoam = 0x30,

    /// <summary>
    /// Запрос состояния подсветки кнопки Пена + вода
    /// </summary>
    GetBacklightButtonFoamWater = 0x31,

    /// <summary>
    /// Запрос состояния подсветки кнопки Горячая вода
    /// </summary>
    GetBacklightButtonHotWater = 0x32,

    /// <summary>
    /// Запрос состояния подсветки кнопки Холодная вода
    /// </summary>
    GetBacklightButtonCoolWater = 0x33,

    /// <summary>
    /// Запрос состояния подсветки кнопки Воск
    /// </summary>
    GetBacklightButtonVosk = 0x34,

    /// <summary>
    /// Запрос состояния подсветки кнопки Осмос
    /// </summary>
    GetBacklightButtonOsmos = 0x35,

    /// <summary>
    /// Запрос состояния подсветки кнопки Стоп
    /// </summary>
    GetBacklightButtonStop = 0x36,

    /// <summary>
    /// Команда начислить средства по 1 каналу монетоприемника
    /// </summary>
    SetCoinAcceptorChanel1 = 0x37,

    /// <summary>
    /// Команда начислить средства по 2 каналу монетоприемника
    /// </summary>
    SetCoinAcceptorChanel2 = 0x38,

    /// <summary>
    /// Команда начислить средства по 3 каналу монетоприемника
    /// </summary>
    SetCoinAcceptorChanel3 = 0x39
}