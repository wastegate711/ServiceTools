...
namespace ServiceTools.Services.ControlBlock.Helpers
{
    public class ConstructorControlBlock : IConstructorControlBlock
    {
        private readonly GlobalSettings _globalSettings;

        public ConstructorControlBlock(GlobalSettings globalSettings)
        {
